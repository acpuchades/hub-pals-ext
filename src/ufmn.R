...
ufmn_patients <- DBI::dbReadTable(ufmn_db, "pacientes") %>%
  rows_delete(tibble(pid = "9342fe7c-d949-11e9-842a-ebf9c1d8fdac"), by = "pid") %>% # no data
...
ufmn_respiratory <- DBI::dbReadTable(ufmn_db, "fun_res") %>%
  ...
  rows_update(tibble(id = "a0a869b6-526b-44f3-9137-044c30b29551", fvc_estirado_absoluto = "2450"), by = "id") %>% # was 24500
  rows_update(tibble(id = "1915a65d-ecd0-4390-b60f-a87ea269898d", ct90 = NA, sao2_media = NA), by = "id") %>% # multiple errors
  rows_update(tibble(id = "0a668c6e-89ee-11e8-8428-29c4852a0217", hco3 = "33"), by = "id") %>% # was 3
  rows_update(tibble(id = "172665b8-47b4-11e8-915c-1db1c3288c02", fvc_sentado_absoluto = "920", fvc_estirado_absoluto = "920"), by = "id") %>% # both were 9100
  rows_update(tibble(id = "2786aece-9a1e-11e8-9eb2-af099be7b978", ct90 = "6"), by = "id") %>% # was 99.7
  rows_update(tibble(id = "3f94f6b5-0478-413c-96a4-86607e149447", pao2 = "102", paco2 = "32", hco3 = "21"), by = "id") %>% # values were flipped or missing
  rows_update(tibble(id = "7ee47f8a-bdf0-4db2-88b2-5f1d2ac28061", ct90 = "0.8", sao2_media = "95.98"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "7dcc96e9-7c4d-4535-a069-916574678a2c", ph_sangre_arterial = "7.46", hco3 = "27"), by = "id") %>% # values were missing
  rows_update(tibble(id = "613d31ec-fd2f-42c2-8ef8-fb90b0704bea", ph_sangre_arterial = NA, pao2 = NA, paco2 = NA, hco3 = NA), by = "id") %>% # abg not performed
  rows_update(tibble(id = "e8d20b44-9d34-4f8a-b076-2c1eb51473fc", ph_sangre_arterial = NA, pao2 = NA, paco2 = NA, hco3 = NA), by = "id") %>% # abg not performed
  rows_update(tibble(id = "7dd109f6-ce38-11e9-8beb-d1a9b58e35a5", fvc_estirado = "89"), by = "id") %>%
  rows_update(tibble(id = "f8ed6057-1f8f-4364-b39d-af298e032b8d", ph_sangre_arterial = NA, pao2 = NA, paco2 = NA, hco3 = NA), by = "id") %>% # abg not performed
  rows_update(tibble(id = "41b51e5e-ce28-11e9-8beb-d1a9b58e35a5", pim = "18"), by = "id") %>% # was 218
  rows_update(tibble(id = "1d3044ed-6c4b-4c87-9a8f-522c92e4bbe4", ph_sangre_arterial = NA, pao2 = NA, paco2 = NA, hco3 = NA), by = "id") %>% # abg not performed
  rows_update(tibble(id = "ef41001c-8e86-4d5f-a340-cec5d0291c53", ph_sangre_arterial = NA, pao2 = NA, paco2 = NA, hco3 = NA), by = "id") %>% # abg not performed
  rows_update(tibble(id = "66462823-8dfd-4654-a9ef-2200c618b13f", ph_sangre_arterial = NA, pao2 = NA, paco2 = NA, hco3 = NA), by = "id") %>% # abg not performed
  rows_update(tibble(id = "e45cdc18-1da2-11ea-a82e-af00877d97ef", fvc_sentado_absoluto = "4120"), by = "id") %>% # was 41200
  rows_update(tibble(id = "38156092-e761-11e8-807a-7b0007981048", hco3 = "26"), by = "id") %>% # was 2
  rows_update(tibble(id = "5ebd2a1e-4945-11e8-a423-f10b658f4c3d", ct90 = "6"), by = "id") %>% # was 90.6
  rows_update(tibble(id = "2e051a84-837e-11e9-9ede-f367b00f4244", ct90 = "3"), by = "id") %>% # was 90.3
  rows_update(tibble(id = "f53b17fe-837c-11e9-9ede-f367b00f4244", ct90 = "0"), by = "id") %>% # was 90.0
  rows_update(tibble(id = "3931c054-8380-11e9-9ede-f367b00f4244", ct90 = "1"), by = "id") %>% # was 90.1
  rows_update(tibble(id = "008a5ad4-8382-11e9-9ede-f367b00f4244", ct90 = "5"), by = "id") %>% # was 90.5
  rows_update(tibble(id = "9158e8d6-dc44-11e8-87ef-efc75e1e34cc", paco2 = "41"), by = "id") %>% # was 4
  rows_update(tibble(
    id = "3d3bfffa-3120-11e9-80d3-0938853a2539",
    ph_sangre_arterial = NA, pao2 = NA, paco2 = NA, # abg not performed
    sao2_media = "91", ct90 = "24", odi3 = "10" # values were wrong
  ), by = "id") %>%
  rows_update(tibble(id = "acef89f8-47c8-11e8-a7d0-b52d1edb9069", pao2 = "109", paco2 = "36"), by = "id") %>% # values were wrong
  rows_update(tibble(id = "56e5a8d0-2acb-11e9-8d8b-6bd4a449ee38", pao2 = "93", paco2 = "34"), by = "id") %>% # values were wrong
  rows_update(tibble(id = "afa0cef0-2acb-11e9-8d8b-6bd4a449ee38", pao2 = "92", paco2 = "36"), by = "id") %>% # values were wrong
  rows_update(tibble(id = "052f693e-0605-11ea-89b0-17e7b5a20645", sao2_media = "93", ct90 = "3"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "03bb7c9e-838a-11e9-9ede-f367b00f4244", pao2 = "81", paco2 = "43"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "cc79f9d2-52c9-11e8-880e-7fe41889cc89", fvc_sentado = "39", fvc_sentado_absoluto = "1420"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "ec7f50e6-1dca-11eb-bb4a-9745fc970131", ct90 = "95.8"), by = "id") %>% # was 98.8
  rows_update(tibble(id = "943071c6-ea12-11eb-8de9-5ff3128bc34d", sao2_media = NA, ct90 = NA, odi3 = NA), by = "id") %>% # values were from previous npo
  rows_update(tibble(id = "77223818-305f-11e9-9393-2b87c41589f5", pao2 = "90", paco2 = "34"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "7eeb125e-89bb-11e8-9a8f-6ba51261727f", hco3 = "31"), by = "id") %>% # was 3
  rows_update(tibble(id = "d3b5bcf8-5dc9-11e8-9ce8-cf38f9497e56", pao2 = "73", paco2 = "41", hco3 = "27"), by = "id") %>% # pao2/paco2 values were flipped, hco3 was missing
  rows_update(tibble(id = "fe6dd472-d095-11e9-961d-d3f87ec1e7e1", ph_sangre_arterial = "7.43", pao2 = "85", paco2 = "45"), by = "id") %>% # pao2/paco2 values were flipped, hco3 was missing
  rows_update(tibble(id = "d9ecbe46-0a99-11e9-9997-9759725d7b76", ph_sangre_arterial = "7.47", pao2 = "101", paco2 = "42", hco3 = "31"), by = "id") %>% # values were wrong
  rows_update(tibble(id = "35dc5b76-0a9a-11e9-9997-9759725d7b76", hco3 = "29"), by = "id") %>% # was 2
  rows_update(tibble(
    id = "9c2051c6-0a9a-11e9-9997-9759725d7b76",
    pao2 = NA, paco2 = NA, hco3 = NA, # abg not performed
    sao2_media = "94.8", ct90 = "0.8", odi3 = "7" # values were flipped
  ), by = "id") %>%
  rows_update(tibble(id = "72cb1a14-12a4-11ea-badc-8b5db01dc70c", sao2_media = "92", ct90 = "17", odi3 = "27"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "c7fb0ae6-e06f-11ea-87ad-6151be442ee5", sao2_media = "93"), by = "id") %>% # was 963
  rows_update(tibble(id = "92575848-fafd-11e9-b780-81f732616a71", hco3 = "29"), by = "id") %>% # was 47
  rows_update(tibble(id = "cf16f606-b672-11e8-9abc-77a17ade9338", pao2 = "103", paco2 = "38", hco3 = "24"), by = "id") %>% # pao2/paco2 were flipped, hco3 was missing
  rows_update(tibble(id = "6ed7a648-b675-11e8-9abc-77a17ade9338", ct90 = "0.96"), by = "id") %>% # was 93
  rows_update(tibble(id = "a61a432c-ecdf-11e8-9848-4918586d805c", ct90 = "11"), by = "id") %>% # was 171
  rows_update(tibble(id = "57ddc50c-ece0-11e8-9848-4918586d805c", hco3 = "24"), by = "id") %>% # was 247
  rows_update(tibble(id = "20405d4a-fb07-11e9-b780-81f732616a71", pcf = "350", pns = NA), by = "id") %>% # values were flipped
  rows_update(tibble(id = "e18a485c-a5f5-11e8-b217-99d3df7458ce", sao2_media = "93.8", ct90 = "0.21"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "6112d056-883d-11e9-a996-85cf5f8a7da8", fvc_estirado = "86"), by = "id") %>% # was 400
  rows_update(tibble(id = "f4c4b0b8-81be-11eb-bdaf-35917006ea01", ct90 = NA, sao2_media = NA), by = "id") %>% # not performed
  rows_update(tibble(
    id = "62ee3b20-68ce-11e8-8bba-011ae3e18648",
    ph_sangre_arterial = NA, sao2_media = "95.35", # values were flipped
    ct90 = "3.17", odi3 = "10", # values were missing
    pao2 = NA, paco2 = NA, hco3 = NA # abg not performed
  ), by = "id") %>%
  rows_update(tibble(id = "921815ee-eb6f-11ea-8eab-918bb380203d", fvc_sentado_absoluto = "3310"), by = "id") %>% # was 33310
  rows_update(tibble(id = "4308f4ec-d272-11eb-b08c-851f5b5d129e", fvc_sentado_absoluto = "5420"), by = "id") %>% # was 54200
  rows_update(tibble(id = "d2755b2a-91b0-11e9-8658-35a5d3539e15", hco3 = "30", paco2 = "41"), by = "id") %>% # wrong values
  rows_update(tibble(id = "f1e2bc96-fef7-11e9-b2bc-2bd7e660e45b", hco3 = "23"), by = "id") %>% # was 213
  rows_update(tibble(id = "ccf8c196-22e4-11e8-bd92-937d2f7100b4", ct90 = NA), by = "id") %>% # contained sao2_media
  rows_update(tibble(id = "c5a16d28-1332-11e9-8be2-e38b9cc14280", pao2 = "81", paco2 = "42"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "70746d6c-9a35-11e8-b94f-4f39f1d733d1", hco3 = "27"), by = "id") %>% # was 72
  rows_update(tibble(id = "cdc2459c-9a36-11e8-b94f-4f39f1d733d1", pim = "86"), by = "id") %>% # was 183
  rows_update(tibble(id = "09d93355-45d1-11eb-ab70-71abb58c311a", pim = NA, pem = NA), by = "id") %>% # data not found
  rows_update(tibble(id = "12d3a6e0-138d-11eb-a114-cddc6e0437ad", ct90 = "1.8"), by = "id") %>% # was 138
  rows_update(tibble(id = "ab8aaa2a-53f5-11eb-a974-9774facb76d4", ct90 = "0"), by = "id") %>% # was 90
  rows_update(tibble(id = "b10e0910-f347-11ea-9794-a9e1a185db06", ct90 = "0"), by = "id") %>% # was 90
  rows_update(tibble(id = "62b28c1a-7099-11e8-bffa-fbbf07f4b8c5", pao2 = "94", paco2 = "39"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "20b0cd86-e695-11e9-9a0f-0fdab8b37fe7", pao2 = NA, paco2 = NA), by = "id") %>% # data not found
  rows_update(tibble(id = "b31ada4e-838b-11e9-9ede-f367b00f4244", pao2 = "127", paco2 = "40"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "7f99fe5c-e073-11ea-87ad-6151be442ee5", sao2_media = "93.2", ct90 = "0.8"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "f996787c-aad1-4e66-8335-3964ca55aa7d", pns = NA, pcf = "440"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "3cc517ba-311f-11e9-80d3-0938853a2539", pns = NA, pcf = "185"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "e83a3ad6-b667-11e8-9abc-77a17ade9338", pns = NA, pcf = "450"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "cfbdc066-05fa-11ea-89b0-17e7b5a20645", ct90 = "3.8"), by = "id") %>% # was 90.3
  rows_update(tibble(id = "9b4ef030-cee2-11e7-8d7f-c9c4ce89f9c5", ct90 = "0"), by = "id") %>% # was 90
  rows_update(tibble(id = "a5e3dcc4-d707-11ea-bb6b-31ec986d6c42", ct90 = "0"), by = "id") %>% # was 90
  rows_update(tibble(id = "14c6782e-d5ce-11ec-ab47-f14c5265e448", ct90 = "0.6", sao2_media = "95.8", odi3 = "8"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "a74f9472-c3dc-11e7-b405-7fa326ba76f2", odi3 = "5", ct90 = "1", sao2_media = "93"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "16f87e1c-d7ce-11ea-8786-6f85542dc338", odi3 = "5.8", sao2_media = "94.27", ct90 = "0.26"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "ae050874-8c49-11e9-8c23-a5c3d8474f8f", pao2 = "97", paco2 = "42"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "6913089e-ee98-11ea-aa63-851e06783497", pao2 = "110", paco2 = "39"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "79d5c1ea-4450-11eb-82b7-377ffbad2e56", paco2 = "46", hco3 = "28"), by = "id") %>% # paco2 contained pao2, hco3 was missing
  rows_update(tibble(id = "cd4ba262-2554-11e9-9820-09ea91f975fa", pao2 = "109", paco2 = "36"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "6e20d426-6333-11e8-8914-9b10f80dedd0", pao2 = "97", paco2 = "41"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "b7b20a44-e782-11ea-ba91-5d9fa569562f", ph_sangre_arterial = "7.44"), by = "id") %>% # was 744
  rows_update(tibble(
    id = "91cad63e-df08-11eb-876d-61d8cc6ff0fe",
  ...
  rows_update(tibble(
    id = "2ef0705c-2fe3-11eb-a414-cdc7c2599e4f",
  ...
  rows_update(tibble(
    id = "92553af8-5dcf-11e8-9ce8-cf38f9497e56",
    pao2 = "94", paco2 = "35", # values were flipped
    hco3 = "22" # was missing
  ), by = "id") %>%
  rows_update(tibble(id = "f493676c-ecf7-11ea-9b9d-9d9bdb02a59a", pao2 = "104", paco2 = "40"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "0b34cdbc-0f9e-11eb-9cdd-5b494bd8f088", paco2 = "37"), by = "id") %>% # contained pao2
  rows_update(tibble(id = "2617105e-221b-11ed-9e37-37dec3ae1adb", sao2_media = "91.78"), by = "id") %>% # was 9178
  rows_update(tibble(id = "20ce0a56-3df9-11eb-9383-d3a3b2195eff", pns = "64", pcf = "300"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "56cef280-12c2-11eb-bc61-6193a81164b0", pao2 = "101", paco2 = "43"), by = "id") %>% # values were flipped
  rows_update(tibble(id = "3681751c-fb7c-11ec-9f93-8170d5a8e848", paco2 = "37"), by = "id") %>% # was 85
  rows_update(tibble(id = "97728d44-838d-11e9-9ede-f367b00f4244", pao2 = "108"), by = "id") %>% # was 47108
  rows_update(tibble(
    id = "f3caa9f2-e4db-11e7-8222-4fcf3b7eb7b9",
    ph_sangre_arterial = "7.43", # was 96.2
    pao2 = "98", # contained paco2
    hco3 = "26" # was missing
  ), by = "id") %>%
  rows_update(tibble(id = "91019da8-4a56-11e9-9f98-cd726d473012", ph_sangre_arterial = "7.45"), by = "id") %>% # was 45
  rows_update(tibble(id = "0c57cd06-d936-11e9-87ad-ad3b45e595ef", pns = "28", pcf = "300"), by = "id") %>% # values were flipped
  mutate(
